...
import com.piyushhhod.newsapp.databinding.TopHeadlineItemLayoutBinding
...
class TopHeadlineAdapter(
    ...
    class DataViewHolder(private val binding : TopHeadlineItemLayoutBinding) :
            RecyclerView.ViewHolder(binding.root){
                fun bind (article: Article){
                    ...
                    binding.textViewPublishAt.text = article.publishedAt
    ...
    fun clearData() {
        articleList.clear()  // Or whatever your internal list is called
    }
}